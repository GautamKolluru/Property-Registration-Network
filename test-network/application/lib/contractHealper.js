...
async function getContractInstance(contractName) {
  ...
  // Credentials for user Org1 was initially added to this wallet.
  ...
  let connectionProfile = yaml.load(
    fs.readFileSync("./lib/connection-org1.yaml", "utf8")
  )
  ...
  return channel.getContract("regnet", contractName)
}
